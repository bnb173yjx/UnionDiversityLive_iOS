...
@synthesize staticStickerPic = _staticStickerPic;
-(void) setStaticStickerPic:(UnionGPUViewCapture *)staticStickerPic{
    if (staticStickerPic == nil && _staticStickerPic){
        [_staticStickerPic removeAllTargets];
        [self.vStreamMixer  clearPicOfLayer:_staticStickerLayer];
        [_staticStickerPic stop];
        _staticStickerPic = nil;
        return;
    }
    _staticStickerPic = staticStickerPic;
    [_staticStickerPic removeAllTargets];
    [_staticStickerPic addTarget:self.vStreamMixer atTextureLocation:_staticStickerLayer];
}
